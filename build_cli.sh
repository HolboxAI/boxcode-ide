...
export VSCODE_CLI_UPDATE_ENDPOINT="https://raw.githubusercontent.com/HolboxAI/boxcode-ide-versions/refs/heads/main"

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/HolboxAI/boxcode-ide-insiders/releases"
else
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/HolboxAI/boxcode-ide/releases"
fi
