...
ASSETS_REPOSITORY="${ASSETS_REPOSITORY:-HolboxAI/boxcode-ide}"
BINARY_NAME="${BINARY_NAME:-boxcode-ide}"
GH_REPO_PATH="${GH_REPO_PATH:-HolboxAI/boxcode-ide}"
ORG_NAME="${ORG_NAME:-HolboxAI}"
